...
def _import_config():
    """导入配置模块."""
    try:
        from .config import GUI_QUEUE_INTERVAL, MAX_DISPLAY_HEIGHT, MAX_DISPLAY_WIDTH, MAX_INFO_LINES

        return GUI_QUEUE_INTERVAL, MAX_INFO_LINES, MAX_DISPLAY_WIDTH, MAX_DISPLAY_HEIGHT
    except ImportError:
        sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
        from hys.config import GUI_QUEUE_INTERVAL, MAX_DISPLAY_HEIGHT, MAX_DISPLAY_WIDTH, MAX_INFO_LINES
